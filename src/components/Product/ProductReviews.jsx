    ...
    <section className="mt-20">
      ...
      {canReview && (
        ...
        >
          ...
          <button
            type="submit"
            className="mt-6 bg-black text-white px-8 py-3 rounded-full hover:bg-[#D4AF37] transition"
          >
            Submit Review
          </button>
        </form>
      ...
      {!canReview &&
        ...
        auth.currentUser && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5 mb-8">
            Reviews are available only after your order has been delivered.
          </div>
        )}
